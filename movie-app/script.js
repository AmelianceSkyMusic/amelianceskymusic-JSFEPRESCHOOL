...
window.addEventListener( 'load', () => {
    alert('В рамках учебного проекта автор разрешил себе некие вольности в приоретете UI над UX, которых бы не допустил в реальной жизни!\n\nКстати, если вы не заметили footer — пожалуйста, присмотритесь повнимательней!');
});
